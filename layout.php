			...
			<div class="inner-wrapper">
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Hai... 
							<?php echo $nama;?>!
							Selamat Datang di Website Inventory</h2>
					
						<div class="right-wrapper text-right">
							<ol class="breadcrumbs">
								<li>
									<a href="layouts-header-menu.php">
...
<!-- Mirrored from preview.oklerthemes.com/porto-admin/2.2.0/layouts-header-menu.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Jul 2019 14:06:37 GMT -->
</html>